...
| 18 | Distributional_RL.md | 분포 강화학습 | ⭐⭐⭐⭐ | 리턴 분포, C51, QR-DQN, IQN |
| 19 | Offline_RL.md | 오프라인 RL | ⭐⭐⭐⭐ | 배치 RL, CQL, IQL, 오프라인 정책 최적화 |
| 20 | Goal_Conditioned_RL.md | 목표 조건부 RL | ⭐⭐⭐⭐ | UVFA, HER, 목표 재라벨링, 희소 보상 |
| 21 | Reward_Shaping.md | 보상 형성 | ⭐⭐⭐⭐ | 퍼텐셜 기반 보상 형성, 내재적 동기, 호기심 |
| 22 | Inverse_RL.md | 역강화학습 | ⭐⭐⭐⭐ | IRL, 최대 엔트로피 IRL, GAIL, 시연 학습 |
| 23 | RL_for_Robotics.md | 로봇공학을 위한 RL | ⭐⭐⭐⭐ | 시뮬레이션-실제 전이, 도메인 무작위화, 접촉 조작 |
| 24 | RLHF_Deep_Dive.md | RLHF 심층 분석 | ⭐⭐⭐⭐ | 보상 모델링, PPO 미세 조정, Constitutional AI |
| 25 | World_Models.md | 세계 모델 | ⭐⭐⭐⭐ | Dreamer, RSSM, 잠재 상상, 모델 기반 계획 |
| 26 | Imitation_Learning.md | 모방 학습 | ⭐⭐⭐⭐ | 행동 복제, DAgger, GAIL, 오프라인 모방 |
| 27 | Safe_RL.md | 안전 강화학습 | ⭐⭐⭐⭐ | 제약 MDP, CPO, 안전 레이어, 위험 회피 RL |
| 28 | Capstone_RL_Agent.md | 캡스톤: RL 에이전트 | ⭐⭐⭐⭐ | 엔드투엔드 RL 프로젝트, 커스텀 환경, 전체 파이프라인 |
...
13. **13_Model_Based_RL.md** - 학습된 모델을 이용한 계획
14. **14_Soft_Actor_Critic.md** - 연속 제어를 위한 최대 엔트로피 RL

### 5단계: 최신 주제 (3-4주)
18. **18_Distributional_RL.md** - 리턴 분포와 위험 민감 RL
19. **19_Offline_RL.md** - 정적 데이터셋에서 학습
20. **20_Goal_Conditioned_RL.md** - 다목표 학습과 HER
21. **21_Reward_Shaping.md** - 보상 엔지니어링으로 탐색 유도
22. **22_Inverse_RL.md** - 시연에서 보상 함수 학습
23. **23_RL_for_Robotics.md** - 시뮬레이션-실제 전이와 로봇 응용
24. **24_RLHF_Deep_Dive.md** - 인간 피드백으로 LLM 정렬
25. **25_World_Models.md** - 학습된 다이나믹스로 잠재 공간 계획
26. **26_Imitation_Learning.md** - 행동 복제와 DAgger
27. **27_Safe_RL.md** - 제약 최적화와 안전 보장
28. **28_Capstone_RL_Agent.md** - 엔드투엔드 RL 에이전트 프로젝트
