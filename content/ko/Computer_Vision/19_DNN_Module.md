...
3. DNN 모듈을 적용하여 이미지와 비디오 스트림에서 YOLO 기반 객체 탐지(Object Detection)를 수행할 수 있습니다.
4. 실시간 객체 탐지(Object Detection) 과제에서 SSD와 YOLO 아키텍처를 비교할 수 있습니다.
...
**선수 지식**: 딥러닝 기초 개념, 객체 탐지(Object Detection), 이미지 분류
...
4. [YOLO 객체 탐지(Object Detection)](#4-yolo-객체-탐지object-detection)
...
## 4. YOLO 객체 탐지(Object Detection)

### 이론: Anchor 기반 검출: YOLO와 SSD
...
## 7. ONNX를 이용한 최신 객체 탐지(Object Detection)

### 이론: ONNX와 프레임워크 상호운용성
...
객체 탐지(Object Detection)와 분할 분야는 크게 발전했습니다. 다음은 인기 있는 모델들과 ONNX 가용성에 대한 개요입니다:
...
### 문제 1: 객체 탐지(Object Detection) 성능 비교
