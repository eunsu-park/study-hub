...
컴퓨터 아키텍처 학습 가이드를 완료하신 것을 축하합니다! 이제 논리 게이트부터 멀티코어 프로세서까지 컴퓨터의 작동 원리를 포괄적으로 이해하셨습니다. 학습을 계속하려면 소프트웨어 수준의 자원 관리를 다루는 [OS 이론](../OS_Theory/00_Overview.md)이나, 고수준 코드가 학습한 하드웨어에 어떻게 매핑되는지 이해하기 위한 [컴파일러 설계](../Compiler_Design/00_Overview.md)를 탐구해 보세요.
