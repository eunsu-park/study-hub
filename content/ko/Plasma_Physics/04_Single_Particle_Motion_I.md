...
많은 플라즈마에서, gyroradius $r_L$은 장 변화의 스케일 길이 $L$보다 훨씬 작습니다:
...
**Boris 알고리즘** (Boris, 1970)은 플라즈마 시뮬레이션에서 particle pushing을 위한 gold standard입니다. 이것은:
...
전자기장에서의 단일 입자 운동은 플라즈마 kinetic theory의 기초를 형성합니다:
...
플라즈마가 자기장 $\mathbf{B} = 2\hat{\mathbf{z}}$ T에 있습니다. 전기장 $\mathbf{E} = 500\hat{\mathbf{x}}$ V/m이 인가됩니다.
