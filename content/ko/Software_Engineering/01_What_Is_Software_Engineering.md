...
1. 소프트웨어 공학을 정의하고 프로그래밍 및 컴퓨터 과학과 구별하기
2. 소프트웨어 위기(Software Crisis)의 기원과 의의 설명하기
3. 소프트웨어 공학을 어렵게 만드는 소프트웨어의 본질적 특성 설명하기
4. 소프트웨어 시스템의 주요 범주 파악하기
5. 소프트웨어 공학 실무를 이끄는 핵심 원리 나열하기
6. 소프트웨어 공학 팀에서 발견되는 전문 역할 인식하기
