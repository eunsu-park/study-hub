...
| 11 | 11_Positive_Definite_Matrices.md | 양정부호 행렬 | 양/음의 정부호 행렬, Sylvester 판정법, 최적화와의 연결 |
| 12 | 12_Sparse_Matrices.md | 희소 행렬 | 희소 저장 형식, 희소 연산, 그래프 라플라시안 |
| 13 | 13_Numerical_Linear_Algebra.md | 수치 선형대수학 | 부동소수점 문제, 조건수, 반복 해법, 희소 행렬 |
| 14 | 14_Iterative_Methods.md | 반복법 | Jacobi, Gauss-Seidel, 켤레 기울기법, Krylov 부분공간 |
| 15 | 15_Tensors_and_Multilinear_Algebra.md | 텐서와 다중선형대수 | 텐서 곱, 아인슈타인 표기법, einsum, 브로드캐스팅 |
| 16 | 16_Linear_Algebra_in_Machine_Learning.md | ML에서의 선형대수 | 피처 행렬, 커널 방법, 워드 임베딩, 신경망 층 |
| 17 | 17_Linear_Algebra_in_Deep_Learning.md | 딥러닝에서의 선형대수 | 가중치 행렬, 역전파, 어텐션 메커니즘, 텐서 연산 |
| 18 | 18_Linear_Algebra_in_Computer_Graphics.md | 컴퓨터 그래픽스에서의 선형대수 | 동차 좌표, 모델-뷰-투영, 쿼터니언, 레이 트레이싱 |
| 19 | 19_Randomized_Linear_Algebra.md | 랜덤화 선형대수 | 랜덤화 SVD, Johnson-Lindenstrauss, 스케칭, 스트리밍 알고리즘 |
| 20 | 20_Advanced_Topics.md | 고급 주제 | Jordan 표준형, 일반화 고유벡터, 행렬 로그, Kronecker 곱 |
