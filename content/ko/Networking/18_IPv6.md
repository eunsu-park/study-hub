...
**이전**: [실용 네트워크 도구](./17_Practical_Network_Tools.md) | **다음**: [컨테이너 네트워킹](./19_Container_Networking.md)

## 학습 목표(Learning Objectives)

이 레슨을 완료하면 다음을 할 수 있습니다:

1. IPv6의 필요성과 IPv4의 한계를 이해한다
2. IPv6 주소 형식, 표기법, 유형을 마스터한다
3. IPv6 헤더 구조와 IPv4 대비 개선사항을 학습한다
4. 주소 자동 구성 메커니즘(SLAAC, DHCPv6)을 이해한다
5. 인접 탐색 프로토콜(NDP, Neighbor Discovery Protocol)과 그 역할을 학습한다
6. IPv4에서 IPv6로의 전환 메커니즘을 탐구한다
7. IPv6 라우팅 프로토콜을 이해한다
8. IPv6 보안 고려사항을 학습한다
9. IPv6 네트워크를 구성하고 문제를 해결한다

---

인터넷의 IPv4 주소는 바닥나고 있습니다 -- 많은 지역에서는 이미 고갈되었습니다. IPv6는 먼 미래의 기술이 아니라, 모든 네트워크 엔지니어가 반드시 이해해야 하는 현재의 현실입니다. IPv4의 43억 개 주소를 훨씬 능가하는 128비트 주소 공간을 통해 IPv6는 NAT의 필요성을 제거하고, 헤더 처리를 단순화하며, 내장된 자동 구성을 가능하게 합니다. 이 레슨에서는 주소 표기법부터 전환 전략까지 모든 것을 다루어, 오늘날 우리가 살아가는 이중 스택(Dual-Stack) 세계를 준비시켜 드립니다.
