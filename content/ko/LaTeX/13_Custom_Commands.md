...
% Binomial coefficient (named \mybinom to avoid conflict with amsmath's \binom)
\newcommand{\mybinom}[2]{\left(\begin{array}{c} #1 \\ #2 \end{array}\right)}
...
- 이전: [Beamer 프레젠테이션(Beamer Presentations)](12_Beamer_Presentations.md)
