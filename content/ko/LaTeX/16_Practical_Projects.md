...
| L04-05 | 수식, align | 슬라이드의 수학 | 블록의 수학 |
...
### 연습 문제 4: 공유 전문부(Preamble)가 있는 다중 파일 프로젝트
