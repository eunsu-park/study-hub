...
이 폴더는 프로그래밍 분야로서의 셸 스크립팅을 체계적으로 학습할 수 있도록 제공합니다. Bash를 주 셸로 사용하여, 기본적인 스크립팅을 넘어서는 고급 기법, 실전 자동화 패턴, 전문적인 모범 사례를 다룹니다.
...
| 파일 | 난이도 | 핵심 주제 |
|------|-----------|------------|
| [01_Shell_Fundamentals.md](./01_Shell_Fundamentals.md) | ⭐ | 셸 종류(bash/sh/zsh/dash), POSIX, login/non-login, profile/bashrc 로딩, exit codes |
...
| [09_Process_Management.md](./09_Process_Management.md) | ⭐⭐⭐ | 백그라운드 작업, 서브셸, 시그널 & trap, 정리 패턴, coproc |
...
1. **Foundation (1주차)**: 01 → 02 → 03 → 04
   - 셸 기초를 빠르게 복습한 후, 파라미터 확장과 배열을 깊이 학습
...
- [Linux/](../Linux/00_Overview.md) - Linux 기초, 셸 기본
- [Git/](../Git/00_Overview.md) - 버전 관리 (스크립트는 Git 훅에서 자주 사용)
- [Docker/](../Docker/00_Overview.md) - 컨테이너 엔트리포인트는 셸 스크립트 사용
