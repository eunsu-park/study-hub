...
| [페이지 교체](./15_Page_Replacement.md) | ⭐⭐⭐ | FIFO, LRU, LFU, Clock, 스래싱 |
...
| 파일명 | 난이도 | 주요 내용 |
|--------|--------|----------|
| [20_Advanced_Virtual_Memory.md](./20_Advanced_Virtual_Memory.md) | ⭐⭐⭐ | 고급 페이징, 메모리 맵 파일, Copy-on-Write |
| [21_Disk_Scheduling_and_IO.md](./21_Disk_Scheduling_and_IO.md) | ⭐⭐⭐ | 디스크 스케줄링 알고리즘, I/O 최적화 |
| [22_Real_Time_OS.md](./22_Real_Time_OS.md) | ⭐⭐⭐ | 실시간 스케줄링, 경성/연성 실시간, RTOS 설계 |
| [23_Container_Internals.md](./23_Container_Internals.md) | ⭐⭐⭐ | 네임스페이스, cgroups, 컨테이너 런타임 |
| [24_eBPF_and_Kernel_Tracing.md](./24_eBPF_and_Kernel_Tracing.md) | ⭐⭐⭐⭐ | eBPF 프로그램, 트레이스포인트, 커널 관찰성 |
| [25_OS_Security.md](./25_OS_Security.md) | ⭐⭐⭐ | 접근 제어, 권한(Capabilities), 보안 모듈 |
| [26_Microkernel_Design.md](./26_Microkernel_Design.md) | ⭐⭐⭐⭐ | 마이크로커널 아키텍처, IPC, L4, seL4 |
| [27_Modern_Schedulers.md](./27_Modern_Schedulers.md) | ⭐⭐⭐⭐ | CFS, BFS, EEVDF, 스케줄러 설계 트레이드오프 |
| [28_Capstone_xv6_Walkthrough.md](./28_Capstone_xv6_Walkthrough.md) | ⭐⭐⭐⭐ | xv6 소스 분석, 부팅, 시스템 콜, 파일 시스템 |
...
```
컨테이너, eBPF 트레이싱, 보안, 마이크로커널 설계, 스케줄러 내부 동작 등 현대 OS의 고급 주제를 심층 학습합니다. 캡스톤에서는 xv6 소스 코드를 분석하며 모든 개념을 연결합니다.
...
| [C_Basics/](../C_Basics/00_Overview.md) | 시스템 호출, 멀티스레드 프로그래밍 |
