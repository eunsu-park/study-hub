...
| `11_modes_practice.txt` | Vim 모드 연습 파일 |
| `12_editing_practice.txt` | 기본 편집 연습 파일 |
| `13_visual_mode_practice.txt` | 비주얼 모드 연습 파일 |
| `14_buffers_windows_tabs.txt` | 버퍼, 창, 탭 연습 파일 |
| `15_command_line_advanced.txt` | 명령줄 및 고급 기능 연습 파일 |
| `16_plugins_guide.md` | 플러그인 설치 및 설정 가이드 |
