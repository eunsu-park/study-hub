...
│  │  │                                                            │ │   │
│  │  │  ⚠ 시계 편차(Clock Skew) 주의:                             │ │   │
│  │  │  Snowflake ID는 동기화된 시계에 의존합니다. 서버의 시계가  │ │   │
│  │  │  역방향으로 이동하면(예: NTP 보정), 중복되거나 순서가      │ │   │
│  │  │  어긋난 ID가 생성될 수 있습니다.                            │ │   │
│  │  │                                                            │ │   │
│  │  │  완화 방법:                                                 │ │   │
│  │  │  - 시계가 역방향으로 이동하면 ID 생성 거부                  │ │   │
│  │  │    (시계가 따라잡을 때까지 대기)                             │ │   │
│  │  │  - 가능한 경우 단조 시계(monotonic clock) 소스 사용         │ │   │
│  │  │  - 마지막 타임스탬프를 추적하고 역방향 점프 거부            │ │   │
│  │  │  - 순서 보장을 위해 논리 시계(Lamport/HLC) 고려             │ │   │
│  │  │                                                            │ │   │
│  │  └────────────────────────────────────────────────────────────┘ │   │
│  │                           │                                     │   │
│  │                           ▼                                     │   │
