...
| [서비스 워커와 PWA](./17_Service_Workers_and_PWA.md) | ⭐⭐⭐ | 서비스 워커, 오프라인 캐싱, Progressive Web App |
| [코어 웹 바이탈과 성능](./18_Core_Web_Vitals.md) | ⭐⭐⭐ | Core Web Vitals, 성능 최적화, Lighthouse |
| [웹 컴포넌트](./19_Web_Components.md) | ⭐⭐⭐ | Custom Elements, Shadow DOM, HTML Templates |
