...
| L09 | `09_TensorFlow_Lite.md` | ⭐⭐⭐ | TFLite 변환기, 최적화 옵션, delegate 시스템, TFLM |
| **블록 5: 하드웨어 배포** |
| L10 | `10_PyTorch_Mobile_and_ExecuTorch.md` | ⭐⭐⭐ | PyTorch Mobile, ExecuTorch, 온디바이스 추론 파이프라인 |
| L11 | `11_Edge_Hardware.md` | ⭐⭐⭐ | NPU, TPU Edge, Jetson, Coral, Hailo, 하드웨어 비교 |
| L12 | `12_On_Device_Training.md` | ⭐⭐⭐⭐ | 온디바이스 학습, 연합 학습, 엣지에서의 전이 학습 |
| L13 | `13_Real_Time_Inference.md` | ⭐⭐⭐ | 실시간 추론 최적화, 지연 시간/처리량 프로파일링 |
| **블록 6: 실전 응용** |
| L14 | `14_Edge_AI_for_Computer_Vision.md` | ⭐⭐⭐ | 엣지 비전: 엣지 디바이스에서 객체 검출 및 분할 |
| L15 | `15_Edge_AI_for_NLP.md` | ⭐⭐⭐⭐ | 엣지 NLP: 온디바이스 텍스트 분류 및 키워드 검출 |
| L16 | `16_Deployment_and_Monitoring.md` | ⭐⭐⭐⭐ | 엔드투엔드 배포, 모니터링, 프로덕션 파이프라인 |
