...
| [22_Vector_Storage_and_Indexing.md](./22_Vector_Storage_and_Indexing.md) | 벡터 저장소와 인덱싱 | ⭐⭐⭐ | FAISS 인덱스, Milvus, Weaviate, Qdrant, Pinecone, Chroma, 벤치마크 |
| [23_Production_Vector_Search.md](./23_Production_Vector_Search.md) | 프로덕션 벡터 검색 | ⭐⭐⭐⭐ | 하이브리드 검색, 메타데이터 필터링, 리랭킹, 확장, 모니터링, 비용 최적화 |
...
20. **Dagster**: 자산 기반 오케스트레이션
21. **데이터 버전 관리와 계약**: lakeFS, 데이터 계약, 데이터 메시
22. **벡터 저장소와 인덱싱**: FAISS, Milvus, Weaviate, Qdrant, Pinecone, Chroma
23. **프로덕션 벡터 검색**: 하이브리드 검색, 리랭킹, 확장, 모니터링
