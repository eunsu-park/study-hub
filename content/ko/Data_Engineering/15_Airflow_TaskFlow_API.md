[← 이전: 14. 실전 파이프라인 프로젝트](14_Practical_Pipeline_Project.md) | [다음: 16. Kafka Streams와 ksqlDB →](16_Kafka_Streams_ksqlDB.md)
