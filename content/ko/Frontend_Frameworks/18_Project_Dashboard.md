...
### 이론: 라우팅: 데이터 라우터를 가진 React Router v7
...
### 이론: 컴포넌트 라이브러리: 헤드리스(Radix 또는 Headless UI) + Tailwind
...
### 이론: 상태: 클라이언트에 Zustand + 서버에 TanStack Query
