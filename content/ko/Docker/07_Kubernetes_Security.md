...
4C 모델(Cloud, Cluster, Container, Code)은 각 통제가 속하는 계층을 명명합니다. 체화할 것 — **어떤 단일 메커니즘도 결의에 찬 공격자를 멈추지 못합니다**. RBAC만, NetworkPolicy만, Pod 보안만 모두 우회 방법이 있습니다. 결합하면 —
...
### 이론: Secrets, etcd, encryption-at-rest
