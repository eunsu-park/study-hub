...
**학습 목표**:
- Cowork가 무엇이며 Claude Code와 어떻게 다른지 이해
- 워크플로에 맞게 Cowork 설정 및 구성
- 다양한 도메인에서 다단계 작업 실행에 Cowork 사용
- 플러그인 생태계 탐색 및 관련 플러그인 활성화
- MCP 커넥터를 통해 외부 서비스 연결
- 실용적인 사용 사례에 Cowork 적용 (문서화, 연구, 프로젝트 관리)
- 개인 정보 보호, 데이터 처리, 한계 이해
