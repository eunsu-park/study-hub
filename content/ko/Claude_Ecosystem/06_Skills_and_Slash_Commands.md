...
**학습 목표**:
- 스킬, 훅, CLAUDE.md 명령의 차이점 이해
- SKILL.md 형식을 사용하여 커스텀 스킬 생성
- 스킬 저장 위치 설정 (전역 및 프로젝트 수준)
- 세션 관리를 위한 내장 슬래시 커맨드 사용
- 일반적인 개발 워크플로를 위한 스킬 설계
- 스킬 vs 훅 vs CLAUDE.md 중 언제 무엇을 사용할지 결정
