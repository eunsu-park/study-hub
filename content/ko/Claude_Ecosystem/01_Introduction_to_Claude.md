...
1. Claude 모델 패밀리와 각 모델을 언제 사용할지 이해하기
2. Claude의 핵심 기능과 차별점 파악하기
3. 제품 생태계 탐색: Claude.ai, Claude Code, Claude Desktop, API
4. 컨텍스트 윈도우, 토큰, Claude의 텍스트 처리 방식 이해하기
5. 작업 요구사항에 따른 합리적인 모델 선택 결정하기
6. 가격 책정 모델과 비용 고려사항 이해하기
...
| 속성 | Claude Opus 4.6 | Claude Sonnet 4.6 | Claude Haiku 4.5 |
|------|--------------|-----------------|--------------|
| **지능** | 최고 | 높음 | 양호 |
| **속도** | 느림 | 빠름 | 가장 빠름 |
| **비용** | 최고 | 중간 | 최저 |
| **컨텍스트 윈도우** | 1M 토큰 | 200K 토큰 | 200K 토큰 |
...
최대 1M 토큰(Opus 4.6) 및 200K 토큰(Sonnet 4.6과 Haiku 4.5)의 컨텍스트 윈도우를 통해 Claude는 전체 코드베이스, 긴 문서, 광범위한 대화 기록을 처리할 수 있습니다. 200K 컨텍스트 윈도우는 대략 텍스트 500페이지에 해당하며, Opus 4.6의 1M 토큰 윈도우는 약 2,500페이지를 수용할 수 있습니다.
