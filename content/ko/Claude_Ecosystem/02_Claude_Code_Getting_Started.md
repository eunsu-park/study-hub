...
1. Claude Code 설치 및 인증하기
2. 대화형 세션 시작하고 탐색하기
3. Claude Code가 사용하는 핵심 도구 이해하기 (Read, Write, Edit, Bash, Glob, Grep)
4. 읽기-편집-테스트-커밋 워크플로우 따르기
5. 세션 관리를 위한 기본 슬래시 명령어 사용하기
6. 처음부터 끝까지 실용적인 디버깅 연습 완료하기
