...
```
  ...
  Left:  2-link arm in workspace with a circular obstacle.
  Right: The obstacle maps to an expanded C-obstacle region
         in (theta1, theta2) space. The robot is a single
         point in C-space; planning reduces to point navigation
         around C-obstacles.
```
