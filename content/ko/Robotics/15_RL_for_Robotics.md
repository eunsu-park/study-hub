# 로보틱스를 위한 강화학습(Reinforcement Learning for Robotics)
...
## 로봇 작업을 위한 보상 형성(Reward Shaping)
...
## 시뮬레이션 환경(Simulation Environments)
