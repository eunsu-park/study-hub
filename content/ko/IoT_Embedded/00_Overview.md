...
C_Basics은 마이크로컨트롤러의 저수준 하드웨어 제어를 다루고, IoT_Embedded는 라즈베리파이에서 Python으로 네트워크 연결된 스마트 시스템을 구축하는 방법을 다룹니다.
...
- [C_Basics](../C_Basics/): 저수준 임베디드 프로그래밍 (Arduino, C)
