...
[이전: CNN 기초](./07_CNN_Basics.md) | [다음: 전이학습](./09_Transfer_Learning.md)
...
1. **같은 수용 영역에 더 적은 파라미터**.
2. **더 많은 비선형성.** 각 conv 층은 ReLU가 따르므로, 작은 conv 세 개를 쌓으면 하나 대신 세 개의 비선형성 — 엄격히 더 표현력 있음.
