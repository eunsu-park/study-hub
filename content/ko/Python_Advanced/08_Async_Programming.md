...
> **비유:** 이벤트 루프는 여러 요리를 동시에 조율하는 수석 주방장과 같습니다. 한 요리가 오븐에 들어가(I/O 대기) 있는 동안, 주방장은 가만히 서서 기다리는 대신 다음 주문을 준비하기 시작합니다. `await`는 주방장이 요리를 오븐에 밀어 넣고 다음 작업으로 돌아서는 바로 그 순간입니다.
