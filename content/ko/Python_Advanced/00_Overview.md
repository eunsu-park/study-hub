...
이 토픽은 파이썬의 중급~고급 문법과 패턴을 다룹니다: 데코레이터, 메타클래스, 비동기 프로그래밍, 디스크립터 등.

**선수 지식**: [Python_Basics](../Python_Basics/00_Overview.md) (또는 파이썬 기초 문법 및 OOP에 대한 동등한 지식)
...
- [Python_Basics/](../Python_Basics/00_Overview.md) - 파이썬 기초 문법 및 OOP
- [C_Basics/](../C_Basics/00_Overview.md) - 시스템 프로그래밍 기초
