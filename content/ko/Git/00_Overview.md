...
| [Git 내부 구조](./11_Git_Internals.md) | ⭐⭐⭐⭐ | Git 객체 모델, packfiles, refs |
| [Git Bisect와 디버깅](./12_Git_Bisect_and_Debugging.md) | ⭐⭐⭐ | bisect, blame, 디버깅 워크플로우 |
| [모노레포 워크플로우](./13_Monorepo_Workflows.md) | ⭐⭐⭐⭐ | 모노레포 CI/CD, 변경 감지, 스케일링 |
| [Git Hooks 고급](./14_Git_Hooks_Advanced.md) | ⭐⭐⭐⭐ | 고급 hooks, 자동화, 정책 적용 |
