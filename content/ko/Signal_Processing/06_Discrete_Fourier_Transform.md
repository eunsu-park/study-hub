...
2. 선형성, 원형 시프트(Circular Shift), 원형 합성곱(Circular Convolution), 파르세발 정리(Parseval's Theorem)를 포함한 DFT 성질을 적용할 수 있습니다.
...
| 파르세발 | $\sum |x[n]|^2$ | $\frac{1}{N}\sum |X[k]|^2$ |
