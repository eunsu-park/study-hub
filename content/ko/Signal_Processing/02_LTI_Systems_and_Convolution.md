...
1. LTI 시스템이 신호 처리에서 중요한 이유를 설명할 수 있다
2. 중첩 원리로부터 합성곱 적분과 합성곱 합을 유도할 수 있다
3. 합성곱을 해석적으로 및 수치적으로 계산할 수 있다
4. 합성곱의 성질(교환법칙, 결합법칙, 분배법칙)을 적용할 수 있다
5. 계단 응답(step response)과 임펄스 응답의 관계를 파악할 수 있다
6. 직렬, 병렬, 피드백 시스템 상호연결을 분석할 수 있다
7. 임펄스 응답으로부터 BIBO 안정성을 판별할 수 있다
8. LTI 시스템의 주파수 응답을 계산할 수 있다
