...
**$f(x) = 0$인 경우**: 출력 큐비트는 $\frac{|0\rangle - |1\rangle}{\sqrt{2}} = |-\rangle$이 되므로, 상태는 $+1 \cdot |x\rangle|-\rangle$입니다.

**$f(x) = 1$인 경우**: 출력 큐비트는 $\frac{|1\rangle - |0\rangle}{\sqrt{2}} = -|-\rangle$이 되므로, 상태는 $-1 \cdot |x\rangle|-\rangle$입니다.
