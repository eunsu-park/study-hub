...
본 과정은 의도적인 순서로 구성되어 있습니다: 프레임워크별 심화 학습(레슨 02–13), 어느 프레임워크에나 적용되는 횡단 관심사 패턴(레슨 14–17), 캡스톤 프로젝트(레슨 18), 마지막으로 Go 웹 개발, Redis 캐싱, 작업 큐를 다루는 확장 레슨(레슨 19–21)으로 진행됩니다.
...
| 19 | [Go 웹 기초](./19_Go_Web_Basics.md) | ⭐⭐⭐ | Go net/http, Gin 프레임워크, 미들웨어, 고루틴 동시성 |
| 20 | [Redis 캐싱 패턴](./20_Redis_Caching_Patterns.md) | ⭐⭐⭐ | Redis 자료형, 캐싱 전략, pub/sub, 세션 저장소 |
| 21 | [작업 큐](./21_Job_Queues.md) | ⭐⭐⭐ | Celery, BullMQ, 작업 스케줄링, 재시도 정책, 데드 레터 큐 |
