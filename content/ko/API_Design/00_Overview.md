...
| 11 | 11_API_Testing_and_Validation.md | API 테스트 피라미드, 스키마 검증, 계약 테스트, 퍼즈 테스트 | :star::star::star: | 3시간 |
| 12 | 12_Webhooks_and_Callbacks.md | 웹훅 설계, HMAC 서명, 재시도 정책, 데드 레터 큐 | :star::star::star: | 2시간 |
| 13 | 13_API_Gateway_Patterns.md | API 게이트웨이, BFF 패턴, API 합성, Kong, AWS API Gateway | :star::star::star: | 2시간 |
| 14 | 14_gRPC_and_Protocol_Buffers.md | Protocol Buffers, gRPC 서비스, 스트리밍 패턴, 트랜스코딩 | :star::star::star: | 3시간 |
| 15 | 15_API_Security.md | OWASP API Top 10, 입력 검증, CORS, CSRF, BOLA 방지 | :star::star::star: | 3시간 |
| 16 | 16_API_Lifecycle_Management.md | API 라이프사이클, 변경 로그, 지원 종료, 마이그레이션 가이드 | :star::star::star: | 3시간 |
| 17 | 17_GraphQL_Fundamentals.md | GraphQL 개요, SDL, 타입 시스템, 쿼리 vs 뮤테이션 | :star::star::star: | 3시간 |
| 18 | 18_GraphQL_Schema_Design.md | 스키마 설계, 입력 타입, 열거형, 인터페이스, 유니온, 커스텀 스칼라 | :star::star::star: | 3시간 |
| 19 | 19_GraphQL_Resolvers.md | 리졸버 패턴, 컨텍스트, N+1 문제 해결을 위한 DataLoader | :star::star::star: | 3시간 |
| 20 | 20_GraphQL_Subscriptions.md | 실시간 서브스크립션, WebSocket 전송, pub/sub 패턴 | :star::star::star: | 3시간 |
| 21 | 21_GraphQL_Server_Implementation.md | Strawberry, Apollo Server, 코드 우선 vs 스키마 우선, 미들웨어 | :star::star::star: | 3시간 |
| 22 | 22_GraphQL_Federation.md | 스키마 페더레이션, 서브그래프 설계, 엔티티 해석, Apollo Federation 2 | :star::star::star::star: | 3시간 |
| 23 | 23_GraphQL_Performance_Security.md | 쿼리 복잡도, 깊이 제한, 영속 쿼리, 캐싱, 속도 제한 | :star::star::star::star: | 3시간 |
| 24 | 24_GraphQL_Testing_and_Tooling.md | 테스팅 전략, 모킹, 인트로스펙션, 코드 생성 | :star::star::star: | 3시간 |
| 25 | 25_API_Capstone_Unified_Gateway.md | 통합 API 게이트웨이: REST + GraphQL + gRPC, 마이그레이션 전략 | :star::star::star::star: | 4시간 |
