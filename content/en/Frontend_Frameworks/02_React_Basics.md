...
### Theory: JSX Is Just `React.createElement`
...
### Theory: The Virtual DOM Is a Comparable Value
...
### Theory: The Render → Commit Pipeline
...
### Theory: `key`: How Reconciliation Identifies List Items
