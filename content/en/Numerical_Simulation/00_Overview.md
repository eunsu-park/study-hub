...
| [24_PINN.md](./24_PINN.md) | Physics-Informed Neural Networks (PINN) | Neural network solvers, loss functions from PDEs, automatic differentiation, inverse problems |
