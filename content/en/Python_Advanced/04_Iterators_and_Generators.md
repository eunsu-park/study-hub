...
> **Iterable** contains **Iterator**
>
> - **Iterator**: `__iter__()` returns self, `__next__()` returns next value or raises StopIteration
...
> **Generator Execution Flow**: `count_up_to(3)`
>
> 1. count = 1, `yield 1` --> Return, pause
> 2. (next called) count = 2, `yield 2` --> Return, pause
> 3. (next called) count = 3, `yield 3` --> Return, pause
> 4. (next called) while exits --> StopIteration
