...
**Previous**: [Edge AI for Computer Vision](./14_Edge_AI_for_Computer_Vision.md) | **Next**: [Deployment and Monitoring](./16_Deployment_and_Monitoring.md)

## Learning Objectives

After completing this lesson, you will be able to:

1. Deploy lightweight LLMs (TinyLlama, Phi, Gemma) on edge devices using quantization
2. Optimize Whisper for on-device speech recognition with model distillation and quantization
3. Run text classification on edge devices with efficient transformer alternatives
4. Implement keyword spotting for always-on voice activation with minimal power
5. Deploy on-device translation models for offline language translation
6. Choose the right model size and quantization for NLP tasks on constrained hardware

---

Natural language processing on edge devices has evolved dramatically. What once required cloud APIs -- speech recognition, text classification, even conversational AI -- can now run locally on smartphones and embedded devices. The key enablers are smaller model architectures (distilled transformers, efficient attention mechanisms), aggressive quantization (4-bit and 8-bit), and specialized inference runtimes (llama.cpp, MLC-LLM). This lesson covers the practical techniques for deploying NLP workloads on edge, from tiny keyword spotters to billion-parameter language models.

---

## 1. Lightweight LLMs on Edge

### 1.1 Edge LLM Landscape
...
### 1.2 Running LLMs with llama.cpp
...
### 1.3 Python Integration with llama-cpp-python
...
### 1.4 Quantization Formats Comparison
...
### 2.2 Whisper Optimization for Edge
...
## 3. Text Classification on Edge

### 3.1 Efficient Text Classification Models
...
### 3.3 FastText for Ultra-Fast Classification
...
### 4.1 Keyword Spotting Architecture
...
### 4.2 Keyword Spotter Implementation
...
### 5.1 On-Device Translation Models
...
### 5.2 CTranslate2 Edge Translation
...
### Exercise 1: Edge LLM
1. Download TinyLlama-1.1B in Q4_K_M and Q8_0 GGUF formats
2. Benchmark tokens/sec on your machine with llama.cpp
3. Compare output quality between quantization levels on 5 prompts

### Exercise 2: Keyword Spotting
1. Train a simple keyword spotter on the Google Speech Commands dataset (12 keywords)
2. Quantize to INT8 and convert to TFLite
3. Measure accuracy, model size, and inference latency

### Exercise 3: On-Device Speech Recognition
1. Set up faster-whisper with the tiny model (INT8)
2. Record 5 audio samples and measure WER (Word Error Rate)
3. Compare processing speed between tiny and base models
