...
**Previous**: [Multi-Turn Conversation](./07_Multi_Turn_Conversation.md) | **Next**: [Code Generation Prompting](./09_Code_Generation_Prompting.md)

## Learning Objectives

After completing this lesson, you will be able to:

1. Construct effective vision+text prompts for image analysis, document understanding, and visual reasoning
2. Apply structured prompting techniques to extract information from charts, graphs, and screenshots
3. Design multi-image reasoning workflows that compare, sequence, and synthesize across images
4. Implement multimodal few-shot prompting patterns with image examples
5. Identify limitations and failure modes of vision-language models and design around them

---

Language models that can process both text and images have moved from research curiosity to production tool. When you can send a screenshot alongside a natural language question, entire categories of problems become solvable: extracting data from charts, understanding UI layouts, reading handwritten notes, analyzing medical images, and comparing visual designs. But multimodal prompting requires different techniques than text-only prompting -- the way you frame the visual task, the order of images and text, and your awareness of what vision models cannot do all significantly affect output quality.

This lesson covers the practical techniques for effective multimodal prompting, from basic image analysis to complex multi-image reasoning workflows.

## Table of Contents

1. [Vision+Text Prompting Fundamentals](#1-visiontext-prompting-fundamentals)
2. [Image Analysis Prompts](#2-image-analysis-prompts)
3. [Document Understanding](#3-document-understanding)
4. [Chart and Graph Interpretation](#4-chart-and-graph-interpretation)
5. [Multi-Image Reasoning](#5-multi-image-reasoning)
6. [Spatial Reasoning Prompts](#6-spatial-reasoning-prompts)
7. [OCR and Text Extraction](#7-ocr-and-text-extraction)
8. [Visual Question Answering](#8-visual-question-answering)
9. [Multimodal Few-Shot](#9-multimodal-few-shot)
10. [Limitations and Failure Modes](#10-limitations-and-failure-modes)

---

## 1. Vision+Text Prompting Fundamentals

### 1.1 How Vision Models Process Images
...
### 1.2 Sending Images via the Anthropic API
...
### 1.3 Sending Images via the OpenAI API
...
### 1.5 Prompt Placement: Before vs After the Image
...
### 2.2 Comparative Image Analysis
...
### 3.1 PDF and Screenshot Analysis
...
### 3.2 Multi-Page Document Processing
...
### 3.3 Table Extraction from Documents
...
## 4. Chart and Graph Interpretation

### 4.1 Chart Reading Prompts
...
### 4.2 Chart Data Extraction Pipeline
...
### 4.3 Dashboard Screenshot Analysis
...
### 5.2 Sequential Image Reasoning
...
## 6. Spatial Reasoning Prompts

### 6.1 Spatial Relationship Analysis
...
### 6.2 Spatial Counting and Measurement
...
### 7.1 Text Extraction from Images
...
### 8.2 Multi-Step Visual Reasoning
...
## 9. Multimodal Few-Shot

### 9.1 Few-Shot with Image Examples
...
### 9.2 Template-Based Multimodal Prompting
...
### 10.1 Known Limitations of Vision Models
...
### 10.3 Resolution and Quality Issues
...
### Exercise 2: Chart Data Extraction with Verification
...
### Exercise 3: UI Accessibility Auditor
...
### Exercise 4: Multi-Image Visual Story Understanding
...
### Exercise 5: Multimodal Prompt Template Library
