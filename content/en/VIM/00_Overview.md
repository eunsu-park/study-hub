...
| `11_modes_practice.txt` | Practice file for Vim modes |
| `12_editing_practice.txt` | Practice file for essential editing |
| `13_visual_mode_practice.txt` | Practice file for visual mode |
| `14_buffers_windows_tabs.txt` | Practice file for buffers, windows, and tabs |
| `15_command_line_advanced.txt` | Practice file for command-line and advanced features |
| `16_plugins_guide.md` | Plugin installation and configuration guide |
