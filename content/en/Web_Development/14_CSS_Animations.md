...
### Theory: The Animation Pipeline: Time, Easing, Interpolation
...
### Theory: `transition` vs. `@keyframes` vs. `animation`
...
### Theory: The Render Pipeline Cost Hierarchy
...
### Theory: Scroll-Driven Animations and `prefers-reduced-motion`
