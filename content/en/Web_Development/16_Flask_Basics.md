...
**Previous**: [JavaScript Module System](./15_JS_Modules.md) | **Next**: [Service Workers and PWA](./17_Service_Workers_and_PWA.md)
...
### Theory: WSGI: The Function Signature That Runs Your App
...
### Theory: URL Routing: From Path to Function
...
### Theory: Templates, ORMs, and Where to Put Logic
...
### Theory: The Request/Response Cycle and Contexts
...
Add user authentication to the above app:
