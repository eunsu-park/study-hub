...
### Phase 9: Expert Data Structures (1-2 weeks)
```
30_Heavy_Light_Decomposition → 31_Link_Cut_Tree → 32_Persistent_Segment_Tree
```
...
|--------|----------------|
| [C_Basics/](../C_Basics/00_Overview.md) | Dynamic arrays, linked lists, hash table implementation |
| [CPP_Basics/](../CPP_Basics/00_Overview.md) | STL containers, algorithm header usage |
