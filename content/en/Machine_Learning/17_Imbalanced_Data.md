...
### Theory: Why Imbalance Hurts — the Loss-Surface View
...
### Theory: Evaluating on Imbalanced Data — the Metric Matters
...
### Theory: SMOTE and Its Interpolation Algorithm
...
### Theory: SMOTE Must Live Inside the Pipeline
...
### Theory: Undersampling and the Information Loss Trade-off
...
### Theory: Class Weighting — Re-weighting the Loss Directly
...
### Theory: Threshold Tuning — the Cheapest and Most Underused Tool
...
### Theory: Combining the Tools — a Practical Recipe
