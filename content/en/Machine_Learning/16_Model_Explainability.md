...
### Theory: Local vs Global, and What Explanation Means
...
### Theory: SHAP and the Shapley Value Axioms
...
### Theory: LIME — Local Linear Surrogate
...
### Theory: PDP — the Marginal Effect of a Feature
...
### Theory: ICE — PDP Without the Average
...
### Theory: The Cost of Explainability
...
- **[Interpretable_AI](../Interpretable_AI/00_Overview.md)**: Advanced interpretability — gradient attribution, GradCAM, attention analysis, TCAV, counterfactual explanations, causal fairness, mechanistic interpretability, and AI governance
