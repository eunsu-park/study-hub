...
Every scalar metric is a ratio of subsets of these four numbers:

```
Accuracy   = (TP + TN) / (TP + FN + FP + TN)        ← fraction of all predictions correct
Precision  = TP / (TP + FP)                          ← of those predicted positive, what fraction are right
Recall     = TP / (TP + FN)                          ← of all actual positives, what fraction we found
                                                       (= sensitivity = true positive rate, TPR)
Specificity = TN / (TN + FP)                         ← of all actual negatives, what fraction we ruled out
                                                       (= true negative rate, TNR)
FPR        = FP / (FP + TN) = 1 - specificity        ← of actual negatives, what fraction we falsely flagged
