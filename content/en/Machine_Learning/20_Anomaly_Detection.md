...
**Previous**: [AutoML and Hyperparameter Optimization](./19_AutoML_Hyperparameter_Optimization.md) | **Next**: [Advanced Ensemble](./21_Advanced_Ensemble.md)
...
1. **Statistical**: Normal points have high density under an assumed distribution. Anomalies are low-density tails. Examples: Gaussian + Mahalanobis distance, kernel density estimation.
2. **Distance-based**: Normal points have many close neighbors. Anomalies are isolated. Example: Isolation Forest, Local Outlier Factor.
