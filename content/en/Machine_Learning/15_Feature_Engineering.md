...
- k-NN assumes the target is approximately constant in small neighborhoods.
- Distance-based methods (k-NN, K-Means, SVM with RBF) assume features have comparable scales.
