...
CRDTs are data structures that can be replicated across multiple nodes, updated independently and concurrently without coordination, and always converge to a consistent state.
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  Key Property: Replicas can diverge temporarily but always              │
│  converge without conflict resolution logic.                            │
│                                                                         │
│  Example: G-Counter (Grow-only Counter)                                 │
│                                                                         │
│  Each node maintains its own counter. The total is the sum.             │
│                                                                         │
...
│  All:    {A: 3, B: 5, C: 2}  →  total = 10                             │
│                                                                         │
│  Merge is commutative, associative, and idempotent,                     │
│  so order and duplication of syncs do not matter.                       │
│                                                                         │
│  Common CRDT types:                                                     │
│  ┌─────────────────┬───────────────────────────────────────────────┐   │
...
│  └─────────────────┴───────────────────────────────────────────────┘   │
│                                                                         │
│  Used in: Redis CRDT, Riak, Cassandra counters, collaborative editing  │
│                                                                         │
└─────────────────────────────────────────────────────────────────────────┘
```
...
- "A Comprehensive Study of CRDTs" - Marc Shapiro et al.
