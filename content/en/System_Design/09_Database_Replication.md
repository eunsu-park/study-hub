...
│     └────────────────────────────────────────────────────┘     │
│                                                                 │
│  3. Split-Brain Prevention: Fencing Token Pattern                │
│     ┌────────────────────────────────────────────────────┐     │
│     │                                                    │     │
│     │  Concrete example:                                 │     │
│     │  1. Old Leader holds lease with token T=33         │     │
│     │  2. Network partition occurs                       │     │
│     │  3. New Leader elected with token T=34             │     │
│     │  4. Old Leader tries to write with T=33            │     │
│     │  5. Storage rejects write: T=33 < last seen T=34  │     │
│     │                                                    │     │
│     │  Old Leader (T=33)──write──▶ Storage               │     │
│     │                              "T=33 < 34, REJECT"   │     │
│     │  New Leader (T=34)──write──▶ Storage               │     │
│     │                              "T=34 = 34, ACCEPT"   │     │
│     │                                                    │     │
│     │  The fencing token is a monotonically increasing   │     │
│     │  number issued by the lock/lease service. Storage  │     │
│     │  nodes track the highest token seen and reject any │     │
│     │  write with a lower token.                         │     │
│     │                                                    │     │
│     └────────────────────────────────────────────────────┘     │
│                                                                 │
│  4. Timeout Configuration Dilemma                               │
│     ┌────────────────────────────────────────────────────┐     │
│     │  Timeout too short:                                │     │
