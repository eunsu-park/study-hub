...
│  │  │                                                            │ │   │
│  │  │  ⚠ Clock Skew Caveat:                                     │ │   │
│  │  │  Snowflake IDs depend on synchronized clocks. If a        │ │   │
│  │  │  server's clock drifts backward (e.g., NTP correction),   │ │   │
│  │  │  it may generate duplicate or out-of-order IDs.           │ │   │
│  │  │                                                            │ │   │
│  │  │  Mitigations:                                              │ │   │
│  │  │  - Refuse to generate IDs if clock moves backward         │ │   │
│  │  │    (wait until clock catches up)                           │ │   │
│  │  │  - Use monotonic clock sources where available             │ │   │
│  │  │  - Track last timestamp and reject backward jumps          │ │   │
│  │  │  - Consider logical clocks (Lamport/HLC) for ordering     │ │   │
│  │  │                                                            │ │   │
│  │  └────────────────────────────────────────────────────────────┘ │   │
│  │                           │                                     │   │
│  │                           ▼                                     │   │
