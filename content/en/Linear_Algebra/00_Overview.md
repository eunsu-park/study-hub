...
| 11 | 11_Positive_Definite_Matrices.md | Positive Definite Matrices | Positive/negative definite matrices, Sylvester's criterion, optimization connection |
| 12 | 12_Sparse_Matrices.md | Sparse Matrices | Sparse storage formats, sparse operations, graph Laplacians |
...
| 14 | 14_Iterative_Methods.md | Iterative Methods | Jacobi, Gauss-Seidel, conjugate gradient, Krylov subspaces |
| 15 | 15_Tensors_and_Multilinear_Algebra.md | Tensors and Multilinear Algebra | Tensor products, Einstein notation, einsum, broadcasting |
| 16 | 16_Linear_Algebra_in_Machine_Learning.md | Linear Algebra in ML | Feature matrices, kernel methods, word embeddings, neural network layers |
| 17 | 17_Linear_Algebra_in_Deep_Learning.md | Linear Algebra in Deep Learning | Weight matrices, backpropagation, attention mechanism, tensor operations |
| 18 | 18_Linear_Algebra_in_Computer_Graphics.md | Linear Algebra in Computer Graphics | Homogeneous coordinates, model-view-projection, quaternions, ray tracing |
| 19 | 19_Randomized_Linear_Algebra.md | Randomized Linear Algebra | Randomized SVD, Johnson-Lindenstrauss, sketching, streaming algorithms |
| 20 | 20_Advanced_Topics.md | Advanced Topics | Jordan normal form, generalized eigenvectors, matrix logarithm, Kronecker product |
