...
│  Environment                                                    │
│  ┌─────────┐  state s    ┌─────────────────┐  Q(s,a) for      │
│  │  Atari  │ ──────────▶ │  Online Network  │  all actions     │
│  │  Game   │             │  (θ, updated     │ ──────────▶ argmax
│  │  84x84  │             │   every step)    │              = action
│  └────┬────┘             └────────┬────────┘                   │
│       │                           │ loss                        │
│       │ r, s'                     ▼                             │
│       │              ┌────────────────────────┐                 │
...
│                      └──────────────────────┘                   │
│                                                                 │
│  Replay Buffer:  [ (s,a,r,s',done), ... ]  ← random sample    │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
│       ▼                                                         │
│  ┌─────────────────────┐                                        │
│  │  Shared Feature Net  │  (extracts common state features)     │
│  └──────────┬──────────┘                                        │
│             │                                                   │
│      ┌──────┴──────┐                                            │
│      ▼             ▼                                            │
...
│  │ Value  │  │  Advantage   │                                   │
│  │ Stream │  │   Stream     │                                   │
│  │  V(s)  │  │  A(s, a)     │  (one value per action)          │
│  └────┬───┘  └──────┬───────┘                                   │
│       │             │                                           │
│       └──────┬──────┘                                           │
│              ▼                                                  │
