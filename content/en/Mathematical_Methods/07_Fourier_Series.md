...
[08. Fourier Transforms](08_Fourier_Transforms.md) extends Fourier series, which is limited to periodic functions, to **non-periodic functions** using the **Fourier transform**. We will study the continuous Fourier transform, discrete Fourier transform (DFT), fast Fourier transform (FFT), and the convolution theorem.
