...
- **Previous**: [04. Partial Differentiation](04_Partial_Differentiation.md) — Multivariable calculus, chain rule, Taylor series, Lagrange multipliers
- **Next**: [06. Curvilinear Coordinates](06_Curvilinear_Coordinates.md) — Cylindrical/spherical coordinates, Jacobian, coordinate transformations
