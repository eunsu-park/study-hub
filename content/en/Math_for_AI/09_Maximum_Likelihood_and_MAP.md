...
### 1.3 i.i.d. Assumption and Converting Products to Sums via Log
...
When models have latent (unobserved) variables, neither MLE nor MAP has a closed-form solution. The Expectation-Maximization (EM) algorithm provides an iterative approach to handle such cases.
