...
Among all exponential family distributions, the multivariate Gaussian is especially central to machine learning. Its geometric and algebraic properties make it indispensable in models from linear regression to VAEs.
