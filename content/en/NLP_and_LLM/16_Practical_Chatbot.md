...
>
> 1. **User Input**
> 2. **Intent Classification** --> FAQ / RAG / General dialogue branch
> 3. **Context Retrieval** <-- Vector DB
> 4. **Prompt Construction** <-- Conversation History
> 5. **LLM Generation**
> 6. **Response Output**
...
### Theory: The Chatbot as a Stateful Function
...
### Theory: Conversation Memory Architectures
...
### Theory: Streaming and Latency Budget
...
### Theory: Safety, Moderation, and Refusal
