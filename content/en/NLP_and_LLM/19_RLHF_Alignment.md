...
### Theory: Why Alignment is Needed
...
### Theory: Three-Stage RLHF Pipeline
...
> **RLHF Pipeline**
>
> - **Stage 1: SFT** -- Base Model --supervised--> SFT Model
> - **Stage 2: Reward Model Training** -- SFT Model --preference data--> Reward Model
> - **Stage 3: PPO Reinforcement Learning** -- SFT Model (Policy) + Reward Model (Critic) --> RLHF Model (Aligned)
...
### Theory: Reward Model and Bradley-Terry
...
### Theory: DPO: Direct Preference Optimization
...
### Theory: Constitutional AI and RLAIF
...
In [20_Evaluation_Metrics.md](./20_Evaluation_Metrics.md), we'll learn about LLM evaluation metrics and benchmarks.
