...
### Theory: Basic Quantization Math
...
### Theory: Quantization Granularity
...
### Theory: GPTQ: Second-Order Error Correction
...
### Theory: AWQ: Activation-Aware Weight Quantization
...
### Theory: NF4 and Double Quantization (bitsandbytes / QLoRA)
...
>
> 1. Base model (4bit quantized, frozen)
> 2. **LoRA A** (FP16, trainable, r x d)
> 3. **LoRA B** (FP16, trainable, d x r)
> 4. Final output = quantized weights + LoRA correction
...
In [18_Inference_Optimization.md](./18_Inference_Optimization.md), we'll learn about LLM inference optimization techniques.
