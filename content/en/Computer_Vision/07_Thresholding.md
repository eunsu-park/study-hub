...
This is classification with a one-dimensional feature (pixel intensity) and a decision boundary at a single point `T`. It is the correct model whenever:

1. The foreground and background have **distinctly different intensities**.
