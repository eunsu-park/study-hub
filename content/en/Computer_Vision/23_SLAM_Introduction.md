...
### Theory: The SLAM Problem: Localization + Mapping
...
### Theory: Visual Odometry: Frame-to-Frame Motion
...
### Theory: Common Architecture: Three Parallel Threads
...
### Theory: Loop Closure: Recognizing Revisited Places
...
### Theory: Pose Graph and Factor Graph Optimization
...
- [25_Semantic_Segmentation.md](./25_Semantic_Segmentation.md) - Pixel-level classification, FCN, U-Net, DeepLab
