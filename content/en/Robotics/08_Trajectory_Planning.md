...
```
  ...
  v_max |............______________..............
      ...
      0 |_______/                      \________
       ...
       (parab.)     (linear q)     (parab.)

  t_b = blend time = v_max / a_max
  Position: parabolic during blends, linear during cruise.
  Acceleration: +a_max, then 0, then -a_max.
```
