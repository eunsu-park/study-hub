...
**Previous**: [Project: Linked List](./05_Project_Linked_List.md) | **Next**: [Project: Hash Table](./07_Project_Hash_Table.md)
...
4. **Min-Stack**: Implement a stack that supports `getMin()` in O(1) time in addition to push and pop

5. **Queue using Two Stacks**: Implement a queue ADT using only two stacks

---

## Next Steps

[Project: Hash Table](./07_Project_Hash_Table.md) -> Let's learn about hash tables!
