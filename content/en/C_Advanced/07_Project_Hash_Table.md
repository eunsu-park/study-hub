...
**Previous**: [Project: Stack and Queue](./06_Project_Stack_Queue.md) | **Next**: [Project: File Encryption](./08_Project_File_Encryption.md)
...
4. **Collision statistics**: Add a function that prints the number of collisions per bucket and the maximum chain length

5. **Generic hash table**: Modify the hash table to accept arbitrary key and value types using `void*` and user-supplied hash/compare functions

---

## Next Steps

[Project: File Encryption](./08_Project_File_Encryption.md) -> Let's build a file encryption tool using bit operations!
