...
**Previous**: [Bit Operations](./03_Bit_Operations.md) | **Next**: [Project: Linked List](./05_Project_Linked_List.md)
...
5. **Shrink policy**: Implement a shrink strategy that halves capacity when size drops below 25%, and benchmark it against never shrinking

---

## Next Steps

[Project: Linked List](./05_Project_Linked_List.md) -> Let's learn about linked lists, the pinnacle of pointers!
