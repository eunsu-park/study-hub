...
**Previous**: [Project: Dynamic Array](./04_Project_Dynamic_Array.md) | **Next**: [Project: Stack and Queue](./06_Project_Stack_Queue.md)
...
5. **LRU Cache**: Implement a simple LRU (Least Recently Used) cache using a doubly linked list and a hash table

---

## Next Steps

[Project: Stack and Queue](./06_Project_Stack_Queue.md) -> Let's build LIFO and FIFO data structures!
