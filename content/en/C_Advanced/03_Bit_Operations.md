...
**Previous**: [Advanced Memory Management](./02_Advanced_Memory_Management.md) | **Next**: [Project: Dynamic Array](./04_Project_Dynamic_Array.md)

Master bit-level manipulation, which is essential for systems programming, embedded development, and performance optimization.
...
### Why Bit Operations Are Essential in Systems Programming
...
> | Pin | - | - | Pin13 | Pin12 | Pin11 | Pin10 | Pin9 | Pin8 |
>
> Bit 5 = 1 -> HIGH output on pin 13 (LED ON)
...
>
> - **DDRx** (Data Direction Register) - Set pin input/output direction. 0 = input (INPUT), 1 = output (OUTPUT)
> - **PORTx** (Port Output Register) - Output mode: HIGH/LOW output. Input mode: Enable pull-up resistor
> - **PINx** (Port Input Register) - Read current pin status
>
...
### Exercise 4: XOR Swap
Implement a swap function that exchanges two integers without using a temporary variable, using only XOR operations.

### Exercise 5: Bit Array
Implement a compact bit array that stores N boolean values using N/8 bytes. Provide `bit_set`, `bit_clear`, `bit_get`, and `bit_toggle` functions.
...
Once you've mastered bit operations, proceed to:
- [04. Project: Dynamic Array](./04_Project_Dynamic_Array.md) - Build a growable array from scratch
