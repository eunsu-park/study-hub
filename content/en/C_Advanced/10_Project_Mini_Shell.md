...
**Previous**: [Process Management](./09_Process_Management.md) | **Next**: [Multithreading](./11_Multithreading.md)
...
### Exercise 5: Here Document
Implement `<<EOF` style here-documents that allow multi-line input to be passed as stdin to a command.
...
Once you have completed the mini shell, proceed to the next lesson:
- [Multithreading in C](./11_Multithreading.md) -- Using pthread for concurrent programming
