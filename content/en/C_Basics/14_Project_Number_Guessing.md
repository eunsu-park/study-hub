...
**Previous**: [Project: Calculator](./13_Project_Calculator.md) | **Next**: [Project: Address Book](./15_Project_Address_Book.md)
...
4. **Proximity hints**: Instead of just "UP/DOWN", add hints like "Very hot!", "Warm", "Cold", "Freezing!" based on how close the guess is

5. **Configurable range**: Let the player set their own minimum and maximum number before the game starts

---

## Next Steps

[Project: Address Book](./15_Project_Address_Book.md) -- Learn about structs and file I/O by building a complete CRUD application.
