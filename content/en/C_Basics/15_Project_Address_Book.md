# Project: Address Book Program

**Previous**: [Project: Number Guessing Game](./14_Project_Number_Guessing.md) | **Next**: [C Advanced](../C_Advanced/00_Overview.md)
...
4. **Duplicate detection**: Before adding a contact, check if the name or phone number already exists and warn the user

5. **Undo delete**: Instead of immediately removing a contact, mark it as deleted and provide an "undo" option that restores the last deleted contact

---

## Next Steps

Congratulations on completing C Basics! Continue your C journey with [C Advanced](../C_Advanced/00_Overview.md) to learn systems programming, advanced data structures, and more.
