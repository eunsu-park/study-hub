...
**Previous**: [Build Tools and Debugging](./12_Build_Tools_and_Debugging.md) | **Next**: [Project: Number Guessing Game](./14_Project_Number_Guessing.md)
...
4. **Makefile integration**: Write a Makefile that compiles the calculator with `-Wall -Wextra -std=c11 -g` and includes a `clean` target

5. **Multi-file split**: Separate the calculator into `main.c`, `calc.c`/`calc.h`, and `io.c`/`io.h`, then update the Makefile to compile all files

---

## Next Steps

[Project: Number Guessing Game](./14_Project_Number_Guessing.md) -- Build a game that reinforces loops, conditionals, and random number generation.
