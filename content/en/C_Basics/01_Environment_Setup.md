...
**Previous**: [C Basics](./00_Overview.md) | **Next**: [Variables and Data Types](./02_Variables_and_Data_Types.md)
...
Now that your environment is ready, let's explore C's type system in [Variables and Data Types](./02_Variables_and_Data_Types.md)!
