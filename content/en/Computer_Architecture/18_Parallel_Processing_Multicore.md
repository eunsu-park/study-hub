...
In the next lesson, [RISC-V Architecture](./19_RISC_V_Architecture.md), we explore the open-source RISC-V instruction set architecture — a modern, modular ISA that is rapidly gaining adoption in both academia and industry.
