...
### Theory: The Four Network Model Invariants
...
### Theory: The Service: A Stable Virtual IP for an Ephemeral Set of Pods
...
### Theory: DNS as the Discovery Layer (CoreDNS)
...
### Theory: kube-proxy: Programming the Kernel, Not Sitting in the Data Path
