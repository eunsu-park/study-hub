...
### Differences from C_Basics

| Category | C_Basics | IoT_Embedded |
|----------|---------------|--------------|
...
C_Basics covers low-level hardware control of microcontrollers, while IoT_Embedded teaches how to build network-connected smart systems on Raspberry Pi using Python.
...
- [C_Basics](../C_Basics/): Low-level embedded programming (Arduino, C)
