...
| 23 | [Vision Agents](23_Vision_Agents.md) | ⭐⭐⭐⭐ | Image analysis, computer use, screenshot workflows, vision-powered agents |
| 24 | [Prompt Caching and Batch API](24_Prompt_Caching_and_Batch_API.md) | ⭐⭐⭐ | Cache breakpoints, cache warming, Message Batches API, cost optimization |
| 25 | [RAG Patterns](25_RAG_Patterns.md) | ⭐⭐⭐⭐ | Retrieval-augmented generation, embeddings, vector stores, hybrid search |
...
**Tier 4 — API & Advanced (Lessons 15–25)**
Build production-grade AI applications: use the Claude API and Agent SDK, create custom tools and agents, optimize costs, master advanced development workflows, and learn best practices for teams and troubleshooting. Advanced lessons cover vision-powered agents (Lesson 23), prompt caching and the Batch API for cost optimization (Lesson 24), and retrieval-augmented generation patterns (Lesson 25).
