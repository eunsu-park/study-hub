...
In the previous lessons (L07–L09), we developed the kinetic framework — the Vlasov equation, Landau damping, and collisional operators. Now we apply these tools to study **electrostatic waves**, where:
