...
**Previous**: [STL Algorithms and Iterators](./12_STL_Algorithms_and_Iterators.md) | **Next**: [CMake and Build Basics](./14_CMake_and_Build_Basics.md)
...
>
> - **try block** -- if exception occurs --> **throw** --> exception propagates --> **catch block**
> - **try block** -- no exception --> **Normal exit**
...
Let's learn about CMake and build basics in [CMake and Build Basics](./14_CMake_and_Build_Basics.md)!
