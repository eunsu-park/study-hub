...
| L45 | `45_Diffusion_Models_Advanced.md` | ⭐⭐⭐⭐⭐ | Diffusion Models Advanced |
| L46 | `46_State_Space_Models.md` | ⭐⭐⭐⭐⭐ | State Space Models |
| L47 | `47_Mixture_of_Experts.md` | ⭐⭐⭐⭐⭐ | Mixture of Experts |

**Total: 47 lessons** (33 concept lessons + 14 implementation lessons)
