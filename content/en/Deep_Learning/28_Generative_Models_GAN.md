...
- **D** wants to assign high probability to real data and low probability to generator outputs — maximizing `V`.
- **G** wants to fool D into assigning high probability to its outputs — minimizing `V`.
