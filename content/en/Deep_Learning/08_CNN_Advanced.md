...
1. **Fewer parameters** for the same receptive field.
2. **More nonlinearities.** Each conv layer is followed by ReLU, so stacking three small convs gives three nonlinearities instead of one — strictly more expressive.
