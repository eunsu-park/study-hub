...
Encoder: "I go to school" → Fixed-size vector
                              ↓
Decoder: Fixed vector → "naneun hakgyoe ganda" (= "I go to school" in Korean)
...
Generating "I" → High attention on "naneun" (= "I" in Korean)
Generating "school" → High attention on "hakgyo" (= "school" in Korean)
```
...
In [17_Attention_Deep_Dive.md](./17_Attention_Deep_Dive.md), we'll dive deeper into attention mechanisms with Query/Key/Value, scaled dot-product, and positional encoding.
