...
1. **Type hints** (Python 3.7+): Parameters are typed, enabling automatic validation and documentation
...
### Theory: ASGI: The Async Server Interface
...
### Theory: Type Hints as a Schema Source
...
### Theory: The Starlette + Pydantic Separation
