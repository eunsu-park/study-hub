...
# === Exercise 7: Chirp Spectrogram Analysis ===
# Problem: Compare spectrograms of single and multi-component chirps;
#          analyze cross-term interference and the effect of smoothing.

def exercise_7():
    """Chirp spectrogram analysis: single chirp, two chirps, and smoothing effect."""
    fs = 1000
    duration = 1.0
    t = np.arange(0, duration, 1/fs)
    N = len(t)

    # Use spectrogram-based approach
    # (a) Single chirp
