...
│
├── C_Basics/               # C fundamentals examples
│   ├── 02_variables/       # Variables and data types
│   ├── 03_operators/       # Operators
│   ├── ...                 # Concept demos + 3 projects
│   └── 15_address_book/    # Address book project
│
├── C_Advanced/             # Advanced C examples
│   ├── 01_advanced_pointers/
│   ├── 04_dynamic_array/
│   ├── 10_minishell/       # Mini shell
│   ├── 11_multithread/     # Multithreading
│   ├── 12_network/         # Network programming
...
│
├── CPP_Basics/             # C++ basics examples
│   └── README.md
│
├── CPP_Advanced/           # C++ advanced examples
│   └── README.md
│
...
```bash
cd examples/C_Advanced/<project>
...
```bash
cd examples/CPP_Basics
make          # Build all
make clean    # Clean

cd examples/CPP_Advanced
make          # Build all
make clean    # Clean
```
...
| C_Basics | 16 | C | Variables, pointers, structs, file I/O, 3 projects |
| C_Advanced | 19 | C | Data structures, systems programming, networking, embedded |
...
| CPP_Basics | — | C++ | C++ fundamentals, classes, inheritance, polymorphism, STL basics |
| CPP_Advanced | — | C++ | Modern C++, templates, move semantics, threading, design patterns |
...
- `content/en/C_Basics/15_Project_Address_Book.md` -> `examples/C_Basics/15_address_book/`
