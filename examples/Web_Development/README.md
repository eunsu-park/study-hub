...
Runnable example code for the Web_Development lessons. Examples cover lessons 01–15; lessons 16–19 are not yet covered by example code.
...
│   └── webpack-example/
│
└── 15_project_spa/       # SPA Project (JS Modules)
    ├── index.html
    ├── style.css
    ├── app.js
    └── router.js
...
> Lessons 16–19 (Flask Basics, Service Workers and PWA, Core Web Vitals, Web Components) do not yet have example code in this folder.
...
| 15 | JS Modules / SPA Project | index.html, app.js, router.js |
